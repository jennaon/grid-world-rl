...
if __name__ == '__main__':
    ...
    start_positions = [(3,16,5),(3,16,6),(2,16,5),(2,16,6),(1,2,1),(1,2,2),(2,2,1),(2,2,2)]
    start = random.sample(start_positions,1)[0]
    default_reward = -.1
    goal_reward = 100
    ...
    #     policy_grids, utility_grids = solver_fn(iterations=50 , discount=discount_)
    #     # pdb.set_trace()
    ...
    #     plt.suptitle('Value Iteration: Max reward %.2f found in %d iterations'%(best_reward, utility_grids.shape[3]))
    ...
    # plt.suptitle('Sample solution found by Q-learning. Max reward %.2f found in %d iterations'
    #                                     %(best_reward, max_iter))
